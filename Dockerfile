...
# Setup prompt
#
RUN echo 'export PS1="[Screenshot Capture API] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Screenshot Capture API] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Screenshot Capture API$(tput sgr0).\n\
\n\
